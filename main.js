...
// haritadaki tıklabma olaylarınızı izler
...
//*kullanıcının konumunu alma
 navigator.geolocation.getCurrentPosition(
    //*konumu alırsa haritayı kullanıcınınkonumuna göre yükler
    (e) => {
       loadMap([e.coords.latitude, e.coords.longitude])
    },

    //*konumu almazsa varsayılan olarak Ankarada başlatır
    () => {
      loadMap([39,9984 , 37,2057]);}
 );
